...
class CRNN(object):
    ...
    def _build_model(self):
        ...
        if self.cfg.use_lstm:
            ...
            logits = slim.fully_connected(logits, self.num_classes, activation_fn=None)
        ...
        # self.logits = logits
        # self.logits_r = slim.fully_connected(logits, 512, activation_fn=None)
        # self.indiv_log = slim.fully_connected(logits, 1, activation_fn=None)
    ...
    def _build_train_op(self):
        ...
        self.ctc_loss = tf.nn.ctc_loss(sequence_length=self.seq_len,
                                        labels=self.labels,
                                       inputs=self.logits,
